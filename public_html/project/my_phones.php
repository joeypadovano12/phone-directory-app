<?php
// public_html/project/my_phones.php
require_once(__DIR__ . "/../../lib/app.php");

if (!is_logged_in()) {
    flash("Log in to view your saved phones.", "warning");
...
$where = "WHERE up.user_id = :user_id AND up.is_active = 1";
...
<head>
    ...
    <title>My Saved Phones</title></head>
<body>
    <?php render_nav(); ?>
    <main class="container py-4">
        <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center">
            <h1>My Saved Phones</h1>
            <?php if ($matching_count > 0): ?>
                <form method="post"
                    action="<?php echo project_url("internal/clear_saved_phones.php"); ?>">
                    <button type="submit">Remove All Saved Phones</button>
                </form>
            <?php endif; ?>
        </div>
        ...
        <?php else: ?>
            <table class="table">
                <tr><th>Rel. ID</th><th>Brand</th><th>Model</th><th>Created</th><th>Saved On</th><th>Action</th></tr>
